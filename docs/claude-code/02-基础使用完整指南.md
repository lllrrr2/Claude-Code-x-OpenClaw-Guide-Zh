...
- **v2.1.90**（[GitHub Release v2.1.90](https://github.com/anthropics/claude-code/releases/tag/v2.1.90)）起新增 **`/powerup`**：交互式课程，用动画演示教 Claude Code 功能。
- **v2.1.92**（[GitHub Release v2.1.92](https://github.com/anthropics/claude-code/releases/tag/v2.1.92)）起 **`/release-notes`** 为交互式版本选择器；**订阅用户**的 **`/cost`** 增加按模型与 cache-hit 的拆分说明（具体字段以终端输出为准）。
...
下列句子摘自 [anthropics/claude-code v2.1.90 · What's changed](https://github.com/anthropics/claude-code/releases/tag/v2.1.90)（英文原文，便于核对）：
...
**一句话理解**：就像考试答题——`low`是快速选择题模式，`high`是详细论述题模式。
...
>
> **更新日期**：2026年4月5日
> **版本**：v1.4（对齐 GitHub v2.1.90 / v2.1.92 release 原文）
